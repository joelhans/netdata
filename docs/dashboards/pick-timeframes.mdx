...
**Longer timeframes will decrease metrics granularity**. 
...
storage is 256 MiB, which should be enough for 1-3 days of historical metrics. [Configure this storage
capacity](/docs/store/change-metrics-storage.md) and the depth of historical metrics at any time.
