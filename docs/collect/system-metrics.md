...
For information about collecting metrics from service _running on Windows systems_, see the [application metrics
doc](/docs/collect/service-metrics.md#collect-metrics-from-services-running-on-windows).
...
If you don't use containers, skip ahead to collecting [service metrics](/docs/collect/service-metrics.md) with Netdata.
