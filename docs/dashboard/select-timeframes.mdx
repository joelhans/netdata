...
There are also many ways to [customize](/docs/dashboard/customize-standard-dashboard.mdx) the standard dashboard
experience, from changing the theme to editing the text that accompanies every section of charts.
...
- Dashboard
  ...
  - **[Select timeframes to visualize](/docs/dashboards/select-timeframes.mdx)**
  ...
  - [Web server reference](/docs/dashboard/reference-web-server.mdx)